...
function generateCartItems(cartItems) {
  ...
  cartItems.forEach((item) => {
    itemsHTML += `
            <div class="cart-item flex items-center justify-around pb-4 border-b border-gray-100">
            <div class="flex flex-col md:flex-row items-center justify-center">
                ...
                <div class="cart-item-counter flex mr-2 items-center">
                    <div data-id="${
                      item.id
                    ...
                    <h4 class="text-gray-400 block flex w-6">x ${
                      item.quantity
                    }</h4>
                    <div data-id="${
                      item.id
                ...
                <div class="cart-item-total-cost ont-bold text-gray-400 flex ">
                    ${numeral(item.price * item.quantity).format('$0,0.00')}
                    <div data-id="${
                      item.id
                    }"  class="cart-item-delete w-10 pl-2 font-bold text-gray-300 cursor-pointer hover:text-gray-400">
